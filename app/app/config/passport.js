        ...
        function (req, email, password, done) { // callback with email and password from our form
            UserModel.findOne({
                ...
                if (user.trendata_user_status == 2 && user.trendata_user_id != 1) {
                    return done(null, false, {
                        message: 'Oops! Your Account is Deleted, Please Contact Admin For Further Information.'
                    });
                }
                
                if (user.trendata_user_status == 0 && user.trendata_user_id != 1) {
                    return done(null, false, {
                        message: 'Oops! Currently Your Account is Deactivate, Please Contact Admin For Further Information.'
                    });
                }
            ...
            // user.getUser(email, password, callback);
            //
            ...
            //     if (!user.validPassword(password, rows[0])) {
