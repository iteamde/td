...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return Promise.all([
      addTranslation(queryInterface, Sequelize, 'chart_views_saved_successfully', 'Chart View saved successfully', 1),
      addTranslation(queryInterface, Sequelize, 'chart', 'Chart', 1)
    ]);
  },

  down: function (queryInterface, Sequelize) {
    return Promise.all([
      removeTranslation(queryInterface, 'chart_views_saved_successfully', 1),
      removeTranslation(queryInterface, 'chart', 1)
    ]);
  }
};
