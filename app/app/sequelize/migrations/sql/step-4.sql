...
(1,	0,	0,	1,	'2017-01-01 00:00:00',	'2017-05-25 05:15:24',	1,	7),
(3,	0,	0,	2,	'2017-01-01 00:00:00',	'2017-05-25 05:15:24',	1,	30),
(4,	0,	0,	6,	'2017-01-01 00:00:00',	'2017-05-25 05:15:24',	1,	29),
(6,	0,	0,	7,	'2017-01-01 00:00:00',	'2017-05-25 05:15:24',	1,	17),
(9,	0,	0,	0,	'2017-01-01 00:00:00',	'2017-01-01 00:00:00',	1,	58),
(10,	0,	0,	0,	'2017-01-01 00:00:00',	'2017-01-01 00:00:00',	1,	59),
(11,	0,	0,	0,	'2017-01-01 00:00:00',	'2017-05-25 05:15:24',	1,	60),
(13,	0,	0,	0,	'2017-03-10 10:59:50',	'2017-03-10 12:59:46',	1,	61),
(14,	NULL,	NULL,	4,	'2017-04-19 15:53:26',	'2017-05-25 05:15:24',	1,	55),
(15,	0,	0,	0,	'2017-04-18 12:58:15',	'2017-04-18 12:58:15',	1,	71),
(16,	0,	0,	0,	'2017-04-19 17:41:05',	'2017-04-19 17:41:05',	1,	73),
(18,	0,	0,	3,	'2017-04-21 18:37:10',	'2017-05-25 05:15:24',	1,	74),
(19,	0,	0,	5,	'2017-04-25 16:05:54',	'2017-05-25 05:15:24',	1,	75);;;;;
...
CREATE TABLE `trendata_financial_data` (
  ...
  KEY `trendata_financial_data_trendata_financial_data_year` (`trendata_financial_data_year`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;;;;;
...
TRUNCATE `trendata_login_details`;;;;;
...
(25,	NULL,	'Promise.props({\r\n        /**\r\n         *\r\n         */\r\n        users: commonChartData.getUsersList(req),\r\n\r\n        /**\r\n         * \"Hiring Costs\" of last month from Financial Inputs\r\n         */\r\n        from_db: (function () {\r\n            var FinancialDataModel = ormModels.FinancialData;\r\n            var currentDate = new Date();\r\n            var lastMonth = new Date(currentDate.getFullYear(), currentDate.getMonth() - 1, 3);\r\n            var valueYear = lastMonth.getFullYear();\r\n            var valueMonth = lastMonth.getMonth();\r\n\r\n            return FinancialDataModel.findOne({\r\n                where: {\r\n                    trendata_financial_data_year: valueYear,\r\n                    trendata_financial_data_created_by: req && req.parentUser && req.parentUser.trendata_user_id || 0\r\n                }\r\n            }).then(function (data) {\r\n                if (! data) {\r\n                    return 0;\r\n                }\r\n\r\n                var value = JSON.parse(data.trendata_financial_data_json_data);\r\n                return parseInt(value && value[0] && value[0].data && value[0].data[valueMonth] && value[5].data[valueMonth].value || 0);\r\n            });\r\n        })()\r\n    }).then(_resolve).catch(_reject);',	'2017-05-05 11:13:27',	'2017-05-05 11:13:27',	76);;;;;
...
(499,	'Some Description for First Name Field',	'first_name_data_dictionary_field_description',	'2017-05-05 17:55:02',	'2017-05-05 17:55:02',	1),
...
(502,	'Some Description for Middle Name Field',	'middle_name_data_dictionary_field_description',	'2017-05-05 17:54:04',	'2017-05-05 17:54:04',	1),
(503,	'Last Name',	'last_name_data_dictionary_field_name',	'2017-05-05 17:53:08',	'2017-05-05 17:53:08',	1),
(504,	'Some Description for Last Name Field',	'last_name_data_dictionary_field_description',	'2017-05-05 17:52:40',	'2017-05-05 17:52:40',	1),
(505,	'Employee ID',	'employee_id_data_dictionary_field_name',	'2017-05-05 17:52:18',	'2017-05-05 17:52:18',	1),
(506,	'Some Description for Employee ID Field',	'employee_id_data_dictionary_field_description',	'2017-05-05 17:51:47',	'2017-05-05 17:51:47',	1),
...
(1,	'john',	'',	'kauf',	'admin@trendata.com',	'2016-04-19',	'2',	'',	'',	0,	0,	'4e8ac6516021035f55e3ac5967236e5d',	'afe9a25fc073a9f7e702532e4f59388a669c49059ca19bbc2fca126d7e639b7ad25169c317572ec49eef24ab301d860240cc4c094d03295980dcde6fc9efb99f',	'73e7b4dcda5ec5c447cc98fec2ccfdc2cfda5dd1',	'1495625533589',	'2017-01-01 00:00:00',	'2017-02-21 10:00:44',	1),
(70,	'Shadi',	'Shadi - Shadi',	'Zebian',	'shadizebian@gmail.com',	'1990-01-01',	'0',	'Android Developer',	'',	1,	NULL,	'6b8b22c149dbbcf7d5663e7a2f8931fd',	'819bff7385dcc58392db79847b5bfe91858631f5a4463ea585f3288dedb37bf374452e5a02003151acb6edc6f069227997323396f3958d1fe653007b0f15f2ce',	'e482b0f62025db7ecc5c7525958fe45e98863b85',	'1495605999888',	'2017-05-17 03:31:53',	'2017-05-24 13:30:38',	1),
(71,	'Shadi TG1',	'Shadi TG - Shadi TG',	'Zebian',	'szebian@techgenies.com',	'1990-01-01',	'0',	'Android Developer',	'',	1,	0,	'4e8ac6516021035f55e3ac5967236e5d',	'afe9a25fc073a9f7e702532e4f59388a669c49059ca19bbc2fca126d7e639b7ad25169c317572ec49eef24ab301d860240cc4c094d03295980dcde6fc9efb99f',	'',	'',	'2017-05-21 22:46:52',	'2017-05-24 04:58:19',	1);;;;;

DROP TABLE IF EXISTS `trendata_user_activity`;;;;;
CREATE TABLE `trendata_user_activity` (
  `trendata_user_activity_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `trendata_user_id` int(10) unsigned DEFAULT NULL,
  `trendata_user_api_execution_time` int(10) unsigned DEFAULT NULL,
  `trendata_user_api_error_message` text COLLATE utf8_unicode_ci,
  `trendata_user_activity_ip_address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trendata_user_activity_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trendata_user_activity_referrer_page` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trendata_user_activity_browser` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trendata_user_activity_session_id` varchar(511) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trendata_user_activity_type` enum('page-call','api-call') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'page-call',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`trendata_user_activity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;;;;;

TRUNCATE `trendata_user_activity`;;;;;
