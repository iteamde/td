...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return Promise.all([
      addTranslation(queryInterface, Sequelize, 'enable_distance_calculation', 'Enable Google Distance calculation', 1)
    ]);
  },

  down: function (queryInterface, Sequelize) {
    return Promise.all([
      removeTranslation(queryInterface, 'enable_distance_calculation', 1)
    ]);
  }
};
