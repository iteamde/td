...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return Promise.all([
      addTranslation(queryInterface, Sequelize, 'help_video', 'Help Video', 1),
      addTranslation(queryInterface, Sequelize, 'metric_history', 'Metric History', 1)
    ]);
  },

  down: function (queryInterface, Sequelize) {
    return Promise.all([
      removeTranslation(queryInterface, 'help_video', 1),
      removeTranslation(queryInterface, 'metric_history', 1)
    ]);
  }
};
