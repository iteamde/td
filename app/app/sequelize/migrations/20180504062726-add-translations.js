...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return Promise.all([
      addTranslation(queryInterface, Sequelize, 'exceeds', 'Exceeds', 1),
      addTranslation(queryInterface, Sequelize, 'separation type', 'Separation Type', 1)
    ]);
  },

  down: function (queryInterface, Sequelize) {
    return Promise.all([
      removeTranslation(queryInterface, 'exceeds', 1),
      removeTranslation(queryInterface, 'separation type', 1)
    ]);
  }
};
