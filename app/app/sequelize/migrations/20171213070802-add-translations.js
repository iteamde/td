...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return addTranslation(queryInterface, Sequelize, 'financial-data-saved', 'Data saved successfully', 1);
  },

  down: function (queryInterface, Sequelize) {
    return removeTranslation(queryInterface, 'financial-data-saved', 1);
  }
};
