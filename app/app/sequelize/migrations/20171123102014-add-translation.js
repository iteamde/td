...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return Promise.all([
      addTranslation(queryInterface, Sequelize, 'email_sent', 'Email has been sent.', 1),
      addTranslation(queryInterface, Sequelize, 'email_tooltip', 'Seperate different emails by a comma', 1)
    ]);
  },

  down: function (queryInterface, Sequelize) {
    return Promise.all([
      removeTranslation(queryInterface, 'email_sent', 1),
      removeTranslation(queryInterface, 'email_tooltip', 1)
    ]);
  }
};