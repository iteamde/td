...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return Promise.all([
      addTranslation(queryInterface, Sequelize, 'incorrect_username_or_password', 'Incorrect username or password', 1)
    ]);
  },

  down: function (queryInterface, Sequelize) {
    return Promise.all([
      removeTranslation(queryInterface, 'incorrect_username_or_password', 1)
    ]);
  }
};
