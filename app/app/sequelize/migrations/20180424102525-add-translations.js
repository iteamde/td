...
module.exports = {
    up: function (queryInterface, Sequelize) {
        return Promise.all([
            addTranslation(queryInterface, Sequelize, 'chart_title', 'Chart Title', 1),
            addTranslation(queryInterface, Sequelize, 'chart_added_successfully', 'Chart successfully added to Dashboard', 1),
            addTranslation(queryInterface, Sequelize, 'chart_description', 'Chart Description', 1)
        ]);
    },

    down: function (queryInterface, Sequelize) {
        return Promise.all([
            removeTranslation(queryInterface, 'chart_title', 1),
            removeTranslation(queryInterface, 'chart_added_successfully', 1),
            removeTranslation(queryInterface, 'chart_description', 1)
        ]);
    }
};
