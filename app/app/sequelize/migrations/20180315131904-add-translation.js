...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return Promise.all([
      addTranslation(queryInterface, Sequelize, 'fields_name_cant_starts_with_custom', 'Field name can\'t starts with "Custom"', 1)
    ]);
  },

  down: function (queryInterface, Sequelize) {
    return Promise.all([
      removeTranslation(queryInterface, 'fields_name_cant_starts_with_custom', 1)
    ]);
  }
};
