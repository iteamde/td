...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return Promise.all([
      addTranslation(queryInterface, Sequelize, 'turn_off_distance_calculation', 'Turn off Google Distance calculation', 1)
    ]);
  },

  down: function (queryInterface, Sequelize) {
    return Promise.all([
      removeTranslation(queryInterface, 'turn_off_distance_calculation', 1)
    ]);
  }
};
